...
**Updated:** hourly upstream, synced here daily. Data through 2026-09-21.
...
```
100 leaders · 4,557 first-hand outputs · 2,618 dated events
x 1,881 · paper 1,540 · podcast 742 · blog 302 · report/talk/interview 92
```
...
| Path | What it is |
|---|---|
| [`data/items.csv`](data/items.csv) | **Start here.** One row per item — all 7,175. Opens in Excel or pandas. |
...
| 路径 | 内容 |
|---|---|
| `data/items.csv` | **从这里开始。**一行一条,共 7,175 条,Excel / pandas 直接打开 |
